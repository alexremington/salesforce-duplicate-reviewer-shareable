...
export SF_REPORT_ID="${SF_REPORT_ID:-accounts}"
export SF_SOQL_FILE="${SF_SOQL_FILE:-${PROJECT_DIR}/queries/report-${SF_REPORT_ID}.soql}"
export DUPLICATE_REVIEWER_STAGING_ROOT="${DUPLICATE_REVIEWER_STAGING_ROOT:-${HOME}/Salesforce Pulls/Duplicate Reviewer/staging}"
