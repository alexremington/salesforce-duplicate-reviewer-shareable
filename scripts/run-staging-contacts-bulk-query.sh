...
export SF_SOQL_FILE="${SF_SOQL_FILE:-${PROJECT_DIR}/queries/contacts.soql}"
export OUT_DIR="${OUT_DIR:-${PROJECT_DIR}/Output/staging-contacts}"
...
autoload_url="${reviewer_url}/?autoload=staging-contacts&object=contact&notify=1&sticky=1&name=${LATEST_CSV_NAME}"
