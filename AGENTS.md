...
- Local Beads workspace metadata under `.beads/` is not release state; it should stay ignored and untracked, and closeout should not treat it as release content.
...
- Any local Beads state should remain ignored and untracked rather than committed as release content.
