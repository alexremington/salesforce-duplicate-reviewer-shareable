...
set "SCRIPT_DIR=%~dp0"
set "NODE_SCRIPT=%SCRIPT_DIR%scripts\run-salesforce-duplicate-label-export.js"
...
if not defined NODE_EXE (
  echo Node.js is required to launch Salesforce Duplicate Labels Export.
...
if not "%EXIT_CODE%"=="0" (
  echo.
  echo Salesforce Duplicate Labels Export failed.
